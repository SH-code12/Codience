...
#     "collapsed": true,
#     "ExecuteTime": {
#      "end_time": "2026-03-13T20:01:16.664221Z",
#      "start_time": "2026-03-13T20:01:16.621103Z"
#     }
#    },
#    "source": [
#     "import pandas as pd\n",
...
#    "metadata": {
#     "ExecuteTime": {
#      "end_time": "2026-03-13T20:01:16.750675Z",
#      "start_time": "2026-03-13T20:01:16.667330Z"
#     }
#    },
#    "cell_type": "code",
#    "source": [
#     "train = pd.read_csv('./Dataset/apacheJIT/apachejit_train.csv')\n",
#     "\n",
#     "train.head()"
#    ],
#    "id": "af4c47b66e371494",
...
#        "4  20.000000   253  253.0  199.000000  "
#       ],
#       "text/html": [
#        "<div>\n",
#        "<style scoped>\n",
...
#        "    <tr>\n",
#        "      <th>0</th>\n",
#        "      <td>06a456ec1670fb26a86f8a18f5b55017ac961f39</td>\n",
#        "      <td>apache/groovy</td>\n",
#        "      <td>True</td>\n",
#        "      <td>False</td>\n",
#        "      <td>2003</td>\n",
...
#        "    <tr>\n",
#        "      <th>1</th>\n",
#        "      <td>79f50a10e7688279664146bb3c18837dada370a4</td>\n",
#        "      <td>apache/groovy</td>\n",
#        "      <td>False</td>\n",
#        "      <td>False</td>\n",
#        "      <td>2003</td>\n",
...
#        "    <tr>\n",
#        "      <th>2</th>\n",
#        "      <td>42437917f185f8efa3d947fae3bb08b584504650</td>\n",
#        "      <td>apache/groovy</td>\n",
#        "      <td>False</td>\n",
#        "      <td>False</td>\n",
#        "      <td>2003</td>\n",
...
#        "    <tr>\n",
#        "      <th>3</th>\n",
#        "      <td>b6616e5fb6d537229d307cf8647ef483468175a6</td>\n",
#        "      <td>apache/groovy</td>\n",
#        "      <td>True</td>\n",
#        "      <td>False</td>\n",
#        "      <td>2003</td>\n",
...
#        "    <tr>\n",
#        "      <th>4</th>\n",
#        "      <td>5d0abaebf0bd4b5d98f9ef173f23b3be5e6fb37f</td>\n",
#        "      <td>apache/groovy</td>\n",
#        "      <td>True</td>\n",
#        "      <td>False</td>\n",
#        "      <td>2003</td>\n",
...
#    "metadata": {
#     "ExecuteTime": {
#      "end_time": "2026-03-13T20:01:16.903376Z",
#      "start_time": "2026-03-13T20:01:16.792021Z"
#     }
#    },
#    "cell_type": "code",
#    "source": [
#     "X_train= train.drop(['commit_id','project','fix','year','author_date',\"fix\"],axis=1)\n",
#     "y_train= train['buggy']\n",
#     "X_train"
#    ],
#    "id": "3b744e6cb523161f",
...
#    "metadata": {
#     "ExecuteTime": {
#      "end_time": "2026-03-13T20:01:17.080255Z",
#      "start_time": "2026-03-13T20:01:17.056304Z"
#     }
#    },
#    "cell_type": "code",
#    "source": "y_train",
...
#    "metadata": {
#     "ExecuteTime": {
#      "end_time": "2026-03-13T20:01:17.618958Z",
#      "start_time": "2026-03-13T20:01:17.471043Z"
#     }
#    },
#    "cell_type": "code",
#    "source": [
...
#      "output_type": "stream",
#      "text": [
#       "/Users/rebuy/Desktop/FCAI/GP/MyCode/.venv/lib/python3.14/site-packages/sklearn/linear_model/_logistic.py:406: ConvergenceWarning: lbfgs failed to converge after 100 iteration(s) (status=1):\n",
...
#    "metadata": {
#     "ExecuteTime": {
#      "end_time": "2026-03-13T20:01:17.668238Z",
#      "start_time": "2026-03-13T20:01:17.637058Z"
#     }
#    },
#    "cell_type": "code",
#    "source": [
#     "test = pd.read_csv('./Dataset/apacheJIT/aapachejit_test_large.csv')\n",
#     "test"
#    ],
#    "id": "9c90c3d0fb22f6d8",
#    "outputs": [
...
#        "    <tr>\n",
#        "      <th>0</th>\n",
#        "      <td>999baceff36165d950a61dd9cc4342f252e64837</td>\n",
#        "      <td>apache/flink</td>\n",
#        "      <td>True</td>\n",
#        "      <td>False</td>\n",
#        "      <td>2017</td>\n",
...
#        "    <tr>\n",
#        "      <th>1</th>\n",
#        "      <td>2c799fb70aa47f9109714dc410862af24b4a0321</td>\n",
#        "      <td>apache/hbase</td>\n",
#        "      <td>False</td>\n",
#        "      <td>False</td>\n",
#        "      <td>2017</td>\n",
...
#        "    <tr>\n",
#        "      <th>2</th>\n",
#        "      <td>22ac8c00db676ccc01d1a44ec206ee17790b46b0</td>\n",
#        "      <td>apache/camel</td>\n",
#        "      <td>False</td>\n",
#        "      <td>False</td>\n",
#        "      <td>2017</td>\n",
...
#        "    <tr>\n",
#        "      <th>3</th>\n",
#        "      <td>a9d3412b4ce40f5ab5a18756ede7e0606b653171</td>\n",
#        "      <td>apache/hadoop</td>\n",
#        "      <td>False</td>\n",
#        "      <td>False</td>\n",
#        "      <td>2017</td>\n",
...
#        "    <tr>\n",
#        "      <th>4</th>\n",
#        "      <td>6cf958c2fa7dab4a028039c7c6e8f23456a5d7e5</td>\n",
#        "      <td>apache/groovy</td>\n",
#        "      <td>False</td>\n",
#        "      <td>False</td>\n",
#        "      <td>2017</td>\n",
...
#        "    <tr>\n",
#        "      <th>7521</th>\n",
#        "      <td>f89ffc3ae18d2ff25fe7250c63ee850372b35094</td>\n",
#        "      <td>apache/camel</td>\n",
#        "      <td>False</td>\n",
#        "      <td>False</td>\n",
#        "      <td>2019</td>\n",
...
#        "    <tr>\n",
#        "      <th>7522</th>\n",
#        "      <td>bc0cb5bb0571e0044c5958142c519e9d2b7b610f</td>\n",
#        "      <td>apache/camel</td>\n",
#        "      <td>False</td>\n",
#        "      <td>False</td>\n",
#        "      <td>2019</td>\n",
...
#        "    <tr>\n",
#        "      <th>7523</th>\n",
#        "      <td>ee002068b75f5acaf909d7d82a6d212a879cdeb1</td>\n",
#        "      <td>apache/camel</td>\n",
#        "      <td>False</td>\n",
#        "      <td>False</td>\n",
#        "      <td>2019</td>\n",
...
#        "    <tr>\n",
#        "      <th>7524</th>\n",
#        "      <td>c3c48f30f7450c3a04950805bba7fb1536db7c9d</td>\n",
#        "      <td>apache/hbase</td>\n",
#        "      <td>False</td>\n",
#        "      <td>False</td>\n",
#        "      <td>2019</td>\n",
...
#        "    <tr>\n",
#        "      <th>7525</th>\n",
#        "      <td>36b52fc525876c17f55faff87bed66e91c3cc1e2</td>\n",
#        "      <td>apache/camel</td>\n",
#        "      <td>False</td>\n",
#        "      <td>False</td>\n",
#        "      <td>2019</td>\n",
...
#    "metadata": {
#     "ExecuteTime": {
#      "end_time": "2026-03-13T20:01:17.772188Z",
#      "start_time": "2026-03-13T20:01:17.694078Z"
#     }
#    },
#    "cell_type": "code",
#    "source": [
#     "X_test= test.drop(['commit_id','project','fix','year','author_date',\"fix\"],axis=1)\n",
#     "y_test= test['buggy']"
#    ],
#    "id": "1013dd4a33b8dea6",
#    "outputs": [],
...
#    "metadata": {
#     "ExecuteTime": {
#      "end_time": "2026-03-13T20:01:17.992553Z",
#      "start_time": "2026-03-13T20:01:17.969112Z"
#     }
#    },
#    "cell_type": "code",
...
#    "metadata": {
#     "ExecuteTime": {
#      "end_time": "2026-03-13T20:02:19.359170Z",
#      "start_time": "2026-03-13T20:02:19.329770Z"
#     }
#    },
#    "cell_type": "code",
#    "outputs": [],
...
#    "metadata": {
#     "ExecuteTime": {
#      "end_time": "2026-03-13T20:03:02.533134Z",
#      "start_time": "2026-03-13T20:03:02.507633Z"
#     }
#    },
#    "cell_type": "code",
#    "source": [
...
#    "metadata": {
#     "ExecuteTime": {
#      "end_time": "2026-03-13T20:03:13.140541Z",
#      "start_time": "2026-03-13T20:03:13.108704Z"
#     }
#    },
#    "cell_type": "code",
#    "source": "predictions = loaded_model.predict(X_test)",
#    "id": "685093965681582b",
#    "outputs": [],
#    "execution_count": 44
#   }
